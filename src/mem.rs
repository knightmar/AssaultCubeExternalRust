...
use winapi::um::psapi::{
    EnumProcessModulesEx, EnumProcesses, GetModuleFileNameExW, GetProcessImageFileNameW,
...
impl ProcMem {
    ...
    pub fn module(&self, mod_name: String) -> DWORD {
        ...
        for i in 0..mod_list.len() {
            unsafe {
                GetModuleFileNameExW(self.h_process, mod_list[i], cur_mod.as_mut_ptr(), 260);
            };
